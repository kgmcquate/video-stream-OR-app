...
raw_video_frames_topic_name = "video_stream/video_stream/raw-livestream-frames"
processed_video_frames_topic_name = "video_stream/video_stream/processed-livestream-frames"
